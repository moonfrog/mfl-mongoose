...
function _getPathsToValidate(doc) {
  ...
  var subdocs = doc.$__getAllSubdocs({ useCache: true });
  var subdoc;
...
Document.prototype._mflcachedSubDoc = null;
...
Document.prototype.$__getAllSubdocs = function (options) {
  if (options?.useCache && this._mflcachedSubDoc) {
    return this._mflcachedSubDoc;
  }
  DocumentArray || (DocumentArray = require('./types/documentarray'));
  Embedded = Embedded || require('./types/embedded');
